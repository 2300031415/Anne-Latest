...
const Page = () => {
  ...
  const categoryTabs = useMemo(() => [
    ...
    { id: 2, label: t('tabs.todays_deals', "Today's Deals"), value: 'deals' },
    { id: 3, label: t('tabs.new_releases', 'New Arrivals'), value: 'new' },
    { id: 4, label: t('tabs.best_selling', 'Best Sellers'), value: 'best' },
    { id: 5, label: t('tabs.on_sale', 'On Sale'), value: 'sale' },
  ...
  useEffect(() => {
    if (activeTab === 'custom') {
      // Don't fetch products for custom tab
      return;
    }
